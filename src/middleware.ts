...
const protectedRoutes = ["/", "/customers", "/leads", "/campaigns", "/team", "/calls", "/automations", "/settings", "/forms", "/billing", "/onboarding", "/social", "/solutions", "/inbox", "/calendar"];
...
export default async function middleware(req: NextRequest) {
  ...
  // 5. Redirect to dashboard if the user is authenticated and trying to access login or signup
  if (
    session &&
