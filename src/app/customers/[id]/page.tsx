...
export default async function CustomerDetails({ params }: CustomerDetailsProps) {
    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20 max-w-[1600px] mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-zinc-100 dark:border-white/5 pb-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tight text-zinc-900 dark:text-zinc-50 uppercase italic">{customer.name}</h1>
      ...
      <div className="grid gap-6 lg:grid-cols-12">
          ...
          <div className="rounded-[32px] border border-zinc-200 bg-white p-6 shadow-sm dark:border-white/5 dark:bg-zinc-950">
            ...
            <div className="space-y-4">
              <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5">
                ...
                <span className={`inline-flex items-center rounded-full px-2 py-1 text-xs font-black uppercase tracking-widest ${customer.status === "Active" ? "bg-green-100 text-green-700 dark:bg-green-900/30 dark:text-green-400" : "bg-zinc-200 text-zinc-700 dark:bg-zinc-800 dark:text-zinc-400"
                  }`}>
                  {customer.status}
                </span>
              </div>
              <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5">
                ...
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 truncate">{customer.email}</p>
              </div>
              <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 mb-1">Phone</p>
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 truncate">{customer.phone || "-"}</p>
              </div>
              <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 mb-1">Company</p>
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 truncate">{customer.company || "-"}</p>
              </div>
              <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 mb-1">License / Industry</p>
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 truncate">{customer.licenseType || "-"}</p>
              </div>
              <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 mb-1">Area</p>
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 truncate">{customer.areaOfOperation || "-"}</p>
              </div>
              <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 mb-1">Deal Focus</p>
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 truncate">{customer.dealFocus || "-"}</p>
              </div>
              <div className="p-3 rounded-2xl bg-zinc-50 dark:bg-white/5">
                <p className="text-[10px] font-black uppercase tracking-[0.2em] text-zinc-400 mb-1">Budget</p>
                <p className="text-sm font-bold text-zinc-900 dark:text-zinc-100 truncate">{customer.budgetRange || "-"}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="rounded-[32px] bg-purple-600 p-8 shadow-2xl shadow-purple-500/20 relative overflow-hidden group">
          ...
          <div className="rounded-[32px] border border-zinc-200 bg-white p-6 shadow-sm dark:border-white/5 dark:bg-zinc-950">
            ...
            <div className="space-y-3">
              ...
              {customer.tasks.length === 0 && <p className="text-xs text-zinc-500 italic py-2">No sequences active.</p>}
            </div>
          </div>
          ...
          <div className="rounded-[32px] border border-zinc-200 bg-white p-6 shadow-sm dark:border-white/5 dark:bg-zinc-950">
            ...
            <div className="space-y-3">
              ...
              {customer.deals.length === 0 && <p className="text-xs text-zinc-500 italic py-2">No active pipeline deals.</p>}
            </div>
          </div>
        </div>
      </div>
