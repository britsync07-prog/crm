    ...
    <div className="flex flex-col min-h-screen bg-[#030303] text-zinc-100 overflow-x-hidden selection:bg-indigo-500 selection:text-white font-sans antialiased">
      ...
      <main className="flex-1 relative z-10 pt-48 pb-32">
        ...
        <section className="container mx-auto px-6 text-center space-y-12 max-w-6xl">
          <span className="text-indigo-400 text-[10px] font-black uppercase tracking-[0.4em] italic">Generative Outreach Agents</span>
          <h1 className="text-6xl md:text-9xl font-black tracking-tighter leading-[0.85] text-white">
            Cognitive <br /> <span className="text-indigo-500 italic">Conversations.</span>
          </h1>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-8 rounded-[32px] bg-white/5 border border-white/10 space-y-4 hover:bg-white/[0.08] transition-all">
                <h4 className="text-2xl font-black text-indigo-500 italic">{f.label}</h4>
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5 bg-white/[0.01]">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <h2 className="text-5xl font-black tracking-tighter text-white italic">Sentiment <br /> <span className="text-indigo-500 not-italic">Synchronicity.</span></h2>
            ...
            <div className="p-10 bg-black border border-white/10 rounded-[60px] space-y-6 shadow-2xl">
               <div className="flex justify-between items-center border-b border-white/5 pb-6">
                  ...
                  <span className="text-indigo-500 font-black text-[10px]">AI PROCESSING...</span>
               </div>
               <div className="space-y-4">
                  <p className="text-xs text-zinc-500 border-l-2 border-indigo-500 pl-4 py-2 italic">"Thanks for reaching out, but we just signed a contract with Salesforce last month."</p>
                  <div className="p-4 rounded-2xl bg-indigo-600/10 border border-indigo-500/20 text-indigo-400 text-[10px] font-black uppercase leading-relaxed">
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5">
          <div className="max-w-4xl mx-auto text-center space-y-12">
            <h2 className="text-5xl font-black text-white italic tracking-tighter leading-none">Global Fluency. <br /> <span className="text-indigo-500 not-italic">Localized Nuance.</span></h2>
            ...
            <div className="grid grid-cols-3 md:grid-cols-6 gap-8 pt-12">
               {["EN", "ES", "FR", "DE", "JP", "ZH", "IT", "PT", "NL", "RU", "KO", "AR"].map(lang => (
                 <div key={lang} className="w-16 h-16 rounded-full bg-white/5 border border-white/10 flex items-center justify-center font-black text-xs text-zinc-500 hover:text-white hover:border-indigo-500 transition-all cursor-default">{lang}</div>
               ))}
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5 bg-white/[0.01]">
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            <div className="relative aspect-square rounded-[80px] bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden">
               <Sparkles className="w-48 h-48 text-indigo-500/10 animate-pulse" />
            ...
            <div className="space-y-10 text-left">
              <h2 className="text-5xl font-black tracking-tighter text-white italic">Dynamic <br /> <span className="text-indigo-500 not-italic">Personalization.</span></h2>
          ...
          <div className="text-center space-y-12">
            ...
            <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
               <div className="p-10 rounded-[40px] bg-white/5 border border-white/10 space-y-6 text-left">
                  <span className="px-3 py-1 rounded-full bg-indigo-500/20 text-indigo-400 text-[10px] font-black">VARIANT A</span>
                  ...
                  <div className="h-1.5 w-full bg-zinc-800 rounded-full overflow-hidden mt-8">
                     <div className="h-full bg-indigo-500 w-[42%] shadow-[0_0_15px_rgba(79,70,229,0.5)]"></div>
                  </div>
            ...
            <div className="grid md:grid-cols-3 gap-12">
               {[
                 ...
                 <div key={i} className="space-y-4">
                    <p className="text-4xl font-black text-indigo-500/30 italic">{step.step}</p>
        ...
        <section className="container mx-auto px-6 py-40 text-center space-y-12 border-t border-white/5">
          <h3 className="text-4xl md:text-8xl font-black text-white italic tracking-tighter leading-none">Ready to <br /> <span className="text-indigo-500 not-italic underline underline-offset-8">automate the human?</span></h3>
      ...
      <footer className="bg-[#030303] border-t border-white/5 py-20">
        <div className="container mx-auto px-6 text-center space-y-10">
          ...
          <p className="text-zinc-500 text-xs font-black uppercase tracking-[0.4em]">© 2026 MiniCRM. Precision outreach at scale.</p>
        </div>
      </footer>
    </div>
  );
