    ...
    <div className="flex flex-col min-h-screen bg-[#030303] text-zinc-100 overflow-x-hidden selection:bg-indigo-500 selection:text-white font-sans antialiased">
      ...
      <main className="flex-1 relative z-10 pt-48 pb-32">
        ...
        <section className="container mx-auto px-6 text-center space-y-12 max-w-6xl">
          <span className="text-indigo-400 text-[10px] font-black uppercase tracking-[0.4em] italic">Autonomous Lead Sourcing</span>
          <h1 className="text-6xl md:text-9xl font-black tracking-tighter leading-[0.85] text-white">
            Discovery <br /> <span className="text-indigo-500 italic">without limits.</span>
          </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {["LinkedIn", "Crunchbase", "Apollo", "GitHub", "Twitter/X", "ProductHunt", "Dribbble", "Behance"].map((source) => (
              <div key={source} className="p-8 rounded-[32px] bg-white/5 border border-white/10 flex flex-col items-center justify-center text-center space-y-4 hover:bg-white/[0.08] transition-all">
                <div className="w-12 h-12 rounded-xl bg-indigo-600/20 flex items-center justify-center text-indigo-400 font-black italic">
                  {source[0]}
                </div>
            ...
            <div className="space-y-12">
              ...
              <div className="space-y-6">
                {[
                  ...
                  <div key={i} className="flex gap-6 p-6 rounded-3xl bg-white/5 border border-white/5 hover:border-indigo-500/30 transition-colors">
              ...
              <div className="relative p-1 rounded-[60px] bg-gradient-to-br from-white/10 to-transparent">
                <div className="bg-[#09090b] rounded-[58px] p-12 space-y-8 border border-white/5 overflow-hidden">
                  <div className="flex justify-between items-center mb-8">
                    <span className="text-[10px] font-black uppercase tracking-widest text-indigo-500">Live Intent Stream</span>
                  ...
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-white/5 border border-white/5 animate-pulse" style={{ animationDelay: `${i*300}ms` }}>
                      ...
                      <div className="text-right">
                        <p className="text-lg font-black text-indigo-500">{lead.score}</p>
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5 bg-white/[0.01]">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <h2 className="text-5xl font-black tracking-tighter text-white italic">Verification <br /> <span className="text-indigo-500 not-italic">at the Edge.</span></h2>
              <p className="text-lg text-zinc-400 leading-relaxed font-medium">
              ...
              <div className="flex gap-4">
                ...
                <div className="px-4 py-2 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-indigo-500 text-[10px] font-black uppercase tracking-widest flex items-center gap-2">
                  <CheckCircle2 className="w-3 h-3" /> Syntax Validation
                </div>
              </div>
            </div>
            <div className="p-10 bg-black border border-white/10 rounded-[60px] space-y-6 shadow-2xl shadow-indigo-500/5">
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5">
          <div className="max-w-4xl mx-auto space-y-12">
            <h2 className="text-5xl md:text-7xl font-black text-white italic tracking-tighter leading-none text-center">Track Competitors. <br /> <span className="text-indigo-500 not-italic underline decoration-indigo-500/30 underline-offset-8">Steal Deals.</span></h2>
            <div className="grid md:grid-cols-2 gap-12 pt-12 text-left">
              <div className="p-10 rounded-[40px] bg-white/5 border border-white/10 space-y-6 hover:border-indigo-500 transition-all">
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5">
          <div className="bg-indigo-600 rounded-[60px] p-16 md:p-32 flex flex-col md:flex-row items-center gap-20 overflow-hidden relative shadow-2xl">
            <div className="flex-1 space-y-8 relative z-10 text-left">
              ...
              <button className="px-10 py-5 bg-white text-indigo-600 rounded-2xl font-black uppercase tracking-[0.2em] text-[10px] hover:scale-95 transition-all shadow-2xl">Launch ICP Lab</button>
            </div>
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5 bg-white/[0.01]">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="relative p-12 bg-white/5 border border-white/10 rounded-[60px] space-y-8 backdrop-blur-3xl group hover:border-indigo-500/50 transition-all">
               <TrendingUp className="w-20 h-20 text-indigo-500 opacity-20 group-hover:scale-110 transition-transform duration-1000" />
            ...
            <div className="space-y-10 text-left">
              <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-white italic">Elite Human <br /> <span className="text-indigo-500 not-italic">Augmentation.</span></h2>
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5">
          <div className="bg-indigo-600 rounded-[60px] p-16 md:p-32 text-center space-y-12 relative overflow-hidden shadow-2xl">
            ...
            <p className="text-xl text-indigo-100 font-medium max-w-xl mx-auto italic">High-fidelity data shouldn't be a luxury.</p>
            <div className="grid md:grid-cols-3 gap-12 relative z-10 max-w-5xl mx-auto pt-12">
               ...
               <div className="p-8 rounded-3xl bg-white text-indigo-600 scale-110 shadow-2xl space-y-4">
        ...
        <section className="container mx-auto px-6 py-40 text-center space-y-12 border-t border-white/5">
          <h3 className="text-4xl md:text-8xl font-black text-white italic tracking-tighter">Ready to find <br /> <span className="text-indigo-500 not-italic underline underline-offset-8">your next win?</span></h3>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-8 pt-12">
            <Link href="/signup" className="group bg-indigo-600 text-white px-16 py-8 rounded-[32px] text-2xl font-black transition-all hover:bg-indigo-500 shadow-2xl hover:scale-105 flex items-center gap-4">
      ...
      <footer className="bg-[#030303] border-t border-white/5 py-20">
        <div className="container mx-auto px-6 text-center space-y-10">
          ...
          <p className="text-zinc-500 text-xs font-black uppercase tracking-[0.4em]">© 2026 MiniCRM. The future is autonomous.</p>
        </div>
      </footer>
    </div>
  );
