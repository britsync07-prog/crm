...
export default function EnterpriseShieldPage() {
 ...
 <span className="text-xl font-black tracking-tighter italic text-white hidden sm:block">BritCRM</span>
      ...
      <main className="flex-1 relative z-10 pt-48 pb-32">
        ...
        <section className="container mx-auto px-6 text-center space-y-12 max-w-6xl">
          <span className="text-blue-300 text-[10px] font-black uppercase tracking-[0.4em] italic">Enterprise Governance & Security</span>
          <h1 className="text-6xl md:text-9xl font-black tracking-tighter leading-[0.85] text-white">
            Elite <br /> <span className="text-[#012169] italic">Protection.</span>
          </h1>
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-12 rounded-[60px] bg-white/5 border border-white/10 space-y-8 relative overflow-hidden group hover:border-[#012169]/50 transition-all">
              <div className="absolute -top-20 -right-20 w-64 h-64 bg-[#012169]/10 blur-[100px]"></div>
              <div className="w-16 h-16 rounded-2xl bg-[#012169]/20 flex items-center justify-center text-blue-300">
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5 bg-white/[0.01]">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <h2 className="text-5xl font-black tracking-tighter text-white italic">Identity <br /> <span className="text-[#012169] not-italic">Orchestration.</span></h2>
            ...
            <div className="relative">
               <div className="p-10 bg-zinc-900 border border-white/5 rounded-[40px] shadow-2xl space-y-6">
                  <div className="flex items-center gap-4 border-b border-white/5 pb-6">
                     <Fingerprint className="w-6 h-6 text-[#012169]" />
                  ...
                  <div className="h-2 w-full bg-zinc-800 rounded-full overflow-hidden">
                     <div className="h-full bg-[#012169] w-3/4 animate-pulse"></div>
                  </div>
               </div>
            </div>
          </div>
            ...
            <div className="mt-12 overflow-hidden rounded-[40px] border border-white/10 bg-white/5 text-left shadow-2xl">
               <div className="p-8 space-y-4 font-mono text-[10px] text-zinc-500 uppercase tracking-widest leading-relaxed">
                  <div className="flex justify-between border-b border-white/5 pb-2">
                     ...
                     <span className="text-blue-300">Action: API_KEY_ROTATED</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-2">
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5 bg-white/[0.01]">
          <div className="grid lg:grid-cols-2 gap-32 items-center">
            <div className="order-2 lg:order-1 relative aspect-square rounded-[80px] bg-white/5 border border-white/10 flex items-center justify-center overflow-hidden">
               <Activity className="w-48 h-48 text-[#012169]/10" />
               <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-40 h-40 rounded-full border-2 border-blue-500/20 flex items-center justify-center animate-ping">
                     <Lock className="w-8 h-8 text-[#012169]" />
                  </div>
               </div>
            </div>
            <div className="order-1 lg:order-2 space-y-10 text-left">
              <h2 className="text-5xl font-black tracking-tighter text-white italic">Hardened <br /> <span className="text-[#012169] not-italic">Endpoints.</span></h2>
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5">
          <div className="bg-[#012169] rounded-[60px] p-16 md:p-32 text-center space-y-12 relative overflow-hidden shadow-2xl">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto relative z-10 font-medium leading-relaxed">
        ...
        <section className="container mx-auto px-6 py-40 border-t border-white/5 bg-white/[0.01]">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            ...
            <div className="p-12 rounded-[60px] bg-white/5 border border-white/10 space-y-8 backdrop-blur-3xl text-center">
               <Users className="w-16 h-16 text-[#012169] mx-auto" />
            ...
            <div className="grid md:grid-cols-3 gap-12">
               {[
                 ...
                 <div key={i} className="space-y-4 text-center">
                    <History className="w-8 h-8 text-[#012169]/30 mx-auto mb-4" />
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center">
              {[
                ...
                <div key={i} className="space-y-2">
                  <p className="text-4xl font-black text-[#012169] italic">{item.val}</p>
 ...
 <p className="text-zinc-500 text-xs font-black tracking-[0.4em]">© 2026 BritCRM by BritSync. Security is not an option.</p>
        </div>
      </footer>
    </div>
  );
