      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-zinc-100 dark:border-white/5 pb-8">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-zinc-900 dark:text-zinc-50 uppercase italic flex items-center gap-3">
            <Share2 className="w-8 h-8 text-[#012169]" /> Omni <span className="text-[#012169] not-italic">Social</span>
          </h1>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="bg-zinc-900 rounded-[40px] p-8 text-white relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-[#012169]/20 blur-[100px] rounded-full translate-x-1/4 -translate-y-1/4"></div>
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
              <div className="w-20 h-20 rounded-3xl bg-[#012169] flex items-center justify-center shadow-2xl">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {scheduledPosts.map((post) => (
                <div key={post.id} className="bg-white dark:bg-zinc-950 p-6 rounded-[32px] border border-zinc-200 dark:border-white/10 shadow-sm flex flex-col md:flex-row gap-6 group hover:border-blue-700/30 transition-all">
        ...
        <div className="space-y-8">
          <div className="bg-white dark:bg-zinc-950 p-8 rounded-[40px] border border-zinc-200 dark:border-white/10 shadow-sm space-y-8">
            ...
            <div className="space-y-4">
              {['Facebook', 'LinkedIn', 'Instagram', 'Twitter', 'TikTok'].map((platform) => {
                ...
                return (
                  <div key={platform} className="flex items-center justify-between p-4 rounded-2xl bg-zinc-50 dark:bg-white/5 border border-zinc-100 dark:border-white/5 group hover:border-blue-700/30 transition-all">
                    <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${connected ? 'bg-[#012169] text-white' : 'bg-zinc-200 dark:bg-zinc-800 text-zinc-400'}`}>
          ...
          <div className="bg-[#012169] p-8 rounded-[40px] text-white space-y-6 shadow-2xl shadow-blue-900/20">
            ...
            <div className="space-y-4">
              <div className="flex items-end gap-2">
                ...
                <span className="text-blue-200 text-xs font-bold uppercase mb-1.5">+18%</span>
              </div>
              <div className="h-2 w-full bg-white/10 rounded-full overflow-hidden">
                <div className="h-full bg-white w-2/3 shadow-[0_0_15px_rgba(255,255,255,0.5)]"></div>
              </div>
              <p className="text-[10px] font-bold uppercase text-blue-100 italic">Targeting 60k by EOM</p>
            </div>
          </div>
        </div>
      </div>
